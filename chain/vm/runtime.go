...
func (rt *Runtime) NewActorAddress() address.Address {
	...
	if err := rt.origin.MarshalCBOR(&b); err != nil { // todo: spec says cbor; why not just bytes?NewAc		rt.Abortf(exitcode.ErrSerialization, "writing caller address into a buffer: %v", err)
	}
